...
start = time.time()
logdir = './logs/32VGGLrnNewModel/' + str(time.time())
...
f.write('-- 32VGGLrn(new model) %d depth-----------------------\n' % image_depth)
