...
start = time.time()
logdir = './logs/conv7/' + str(time.time())

np.random.seed(int(time.time()))
tf.set_random_seed(777)  # reproducibility

# hyper parameters
inputDataType = "Conv7_YCbCrR"
learning_rate = 0.002
# training_epochs = 50 (cost 수렴 epoch)
training_epochs = 50
batch_size = 4000
image_depth = 3
...
L5_flat = tf.reshape(L5_3, [-1, 1 * 1 * 512])
...
save_path = saver.save(sess, os.getcwd() + "/" + dirName + "/conv7_" + str(
