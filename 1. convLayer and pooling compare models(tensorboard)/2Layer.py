...
L2_flat = tf.reshape(L2, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L3 FC!!! 32x32xFN inputs -> 1 outputs
W3 = tf.get_variable("W3", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/2Layer')
