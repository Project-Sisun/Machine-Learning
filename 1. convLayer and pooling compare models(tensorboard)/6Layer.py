...
L6_flat = tf.reshape(L6, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L7 FC!!! 32x32xFN inputs -> 1 outputs
W7 = tf.get_variable("W7", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/6Layer')
