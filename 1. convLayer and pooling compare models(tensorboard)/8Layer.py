...
L8_flat = tf.reshape(L8, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L9 FC!!! 32x32xFN inputs -> 1 outputs
W9 = tf.get_variable("W9", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/8Layer')
