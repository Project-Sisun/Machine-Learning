...
L4_flat = tf.reshape(L4, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L5 FC!!! 32x32xFN inputs -> 1 outputs
W5 = tf.get_variable("W5", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/4Layer')
