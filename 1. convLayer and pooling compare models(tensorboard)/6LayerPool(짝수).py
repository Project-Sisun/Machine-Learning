...
# 짝수번째 Layer - max_pool 2*2, strides 2*2
# No dropout
# No ensemble
...
L6_flat = tf.reshape(L6, [-1, 4 * 4 * FN])

# ---------------------------------------------------------------------------------------------------
# L7 FC!!! 4x4xFN inputs -> 1 outputs
W7 = tf.get_variable("W7", shape=[4 * 4 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/6LayerPool22')
