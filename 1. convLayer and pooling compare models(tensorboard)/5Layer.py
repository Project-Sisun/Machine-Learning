...
L5_flat = tf.reshape(L5, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L6 FC!!! 32x32xFN inputs -> 1 outputs
W6 = tf.get_variable("W6", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/5Layer')
