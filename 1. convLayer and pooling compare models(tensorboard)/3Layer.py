...
L3_flat = tf.reshape(L3, [-1, 32 * 32 * FN])

# ---------------------------------------------------------------------------------------------------
# L4 FC!!! 32x32xFN inputs -> 1 outputs
W4 = tf.get_variable("W4", shape=[32 * 32 * FN, nb_classes], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./logs/3Layer')
